...
<head>
    ...
    <meta name="author" content="ariapps" />
    <!-- Favicon-->
    <link rel="shortcut icon" type="image/png" href="assets/logo1-removebg.png" />
    ...
    <script type="application/ld+json">
        {
            ...
            "address": {
                "@type": "PostalAddress",
                "streetAddress": "Calle Plutarco Elías Calles No 138, Col. Barrio Tampiquito",
...
<body id="page-top">
        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="d-flex align-items-center ms-auto me-3">
                    <a href="tel:8118241886" class="text-decoration-none text-dark me-3">
                        <i class="bi bi-telephone me-1"></i> 8118241886
                    </a>
                    <a href="mailto:contacto@secofyl.com" class="text-decoration-none text-dark">
                        <i class="bi bi-envelope me-1"></i> contacto@secofyl.com
                    </a>
                </div>
    ...
    <div class="bg-primary" style="padding-top: 120px;">
        <div class="container">
            <div class="row gx-5 align-items-center justify-content-center" style="min-height: 100dvh;">
                ...
                <div class="col-xl-6 col-xxl-6 d-none d-xl-block text-center">
                    <img class="img-fluid rounded-3 my-5" src="assets/meet.png" alt="Accounting Team" />
                </div>
            </div>
        </div>
    </div>
        ...
        <section class="py-5">
            <div class="container px-md-5 px-4">
                <div class="row gx-5 align-items-center justify-content-center">
                    ...
                    <div class="col-xl-6 col-xxl-6 d-none d-xl-block text-center">
                        <img data-aos="fade-left" class="img-fluid rounded-3 my-5" src="assets/empresarios_oficina.jpg" alt="Accounting Team" />
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="bg-primary" id="services">
            ...
            <section class="py-2" id="services">
                <div class="container-fluid px-5 my-5">
                    ...
                    <div class="row gx-4 row-cols-1 row-cols-md-3 justify-content-center">
                        ...
                        <!-- Alta, Baja y Modificaciones IMSS -->
                        <div class="col mb-4">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body p-5">
                                    <div class="text-main mb-3" style="font-size: 3rem;">
                        ...
                        <!-- Asesoría Administrativa, Fiscal y Legal -->
                        <div class="col mb-4">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body p-5">
                                    <div class="text-main mb-3" style="font-size: 3rem;">
        ...
        <section class="py-2" id="why-choose-us">
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="bg-light rounded-3 p-4">
                            <img class="img-fluid rounded-3" src="assets/trabajando-en-la-oficina.jpg" alt="Man looking forward" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="text-center">
                        <div data-aos="flip-down" class="bg-primary bg-main  text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 80px; height: 80px;">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="row text-center mt-5 align-items-center">
                        ...
                        <div class="col-md-3">
                            <a href="#contact" data-aos="zoom-in" class="btn bg-main text-white btn-lg px-5 py-3 rounded-pill ">
                                Contáctanos
                            </a>
                        </div>
                    </div>
    ...
    <section class="py-2 bg-light" id="clients">
        <div class="container px-4 px-md-5 my-2">
            ...
            <div class="swiper mySwiperClients" style="padding: 50px 0;">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide">
                        <img src="assets/clientes/aar.jpeg" alt="Cliente AAR" class="img-fluid" style="max-height: 100px;">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/clientes/aar2.jpeg" alt="Cliente AAR2" class="img-fluid" style="max-height: 100px;">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/clientes/bellagrace.jpeg" alt="Cliente Bellagrace" class="img-fluid" style="max-height: 100px;">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/clientes/insutec.jpeg" alt="Cliente Insutec" class="img-fluid" style="max-height: 100px;">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/clientes/mebiotec.jpeg" alt="Cliente Mebiotec" class="img-fluid" style="max-height: 100px;">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/clientes/nubograma.jpeg" alt="Cliente Nubograma" class="img-fluid" style="max-height: 100px;">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/clientes/xaerus.jpeg" alt="Cliente Xaerus" class="img-fluid" style="max-height: 100px;">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/clientes/zkteco.jpeg" alt="Cliente ZKTeco" class="img-fluid" style="max-height: 100px;">
                    </div>
                </div>
        ...
        <div class="container px-4 px-md-5 my-5">
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="mb-4">
                        <h4 class="fw-bold mb-3 ff_montserrat" data-aos="flip-down">FAQ</h4>
                    </div>
            ...
            <div class="row gx-5 align-items-start">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <div class="d-flex align-items-start mt-4">
                        <a data-aos="zoom-in-up" href="https://www.instagram.com/secofyl/" target="_blank" class="me-3 text-decoration-none text-dark">
                            <i class="bi bi-instagram" style="font-size: 24px;"></i>
                        </a>
                        <a data-aos="zoom-in-up" href="https://web.facebook.com/people/Secofyl/100063971500353/#" target="_blank" class="text-decoration-none text-dark">
                        ...
                        <div class="card-body p-2 p-md-5">
                            <form class="formulario">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" name="email" type="email"
                                            placeholder="Correo electronio" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="mensaje" id="" cols="10" rows="5"
                                        placeholder="Mensaje"></textarea>
                                </div>

                                <button data-aos="zoom-out-up" type="submit" id="enviar-formulario" class="btn bg-main text-white btn-lg w-100">
                                    Enviar
                                </button>
                            </form>
                        </div>
    ...
    <footer class="bg-white py-4 border-top">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <p class="text-muted small mb-0">© <?php echo date('Y'); ?> Servicios de Contabilidad Fiscal y Legal S de RL de CV. Todos los derechos reservados.</p>
                </div>
                <div class="col-auto">
                    <a href="#" class="text-muted text-decoration-none small me-3">Politica de Privacidad</a>
                    <a href="#" class="text-muted text-decoration-none small">Terminos & Condiciones</a>
                </div>
                <div class="col-auto">
                    <a href="https://www.instagram.com/secofyl/" target="_blank" class="text-muted text-decoration-none small me-3">
                        <i class="bi bi-instagram"></i>
                    </a>
                    <a href="https://web.facebook.com/people/Secofyl/100063971500353/#" target="_blank" class="text-muted text-decoration-none small">
    ...
    <a href="https://wa.me/+5218118241886?text=Estoy%20interesado%20en%20sus%20servicios%20de%20contabilidad" class="float"
        target="_blank" style="text-decoration:none;color:#fff" title="Abrir whatsapp">
        <i class="bi bi-whatsapp" style="margin-top:8px;display: block;"></i>
    </a>
...
<script src="js/scripts.js" crossorigin="anonymous" type=" text/javascript"></script>
